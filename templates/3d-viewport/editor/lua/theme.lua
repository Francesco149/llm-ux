...
theme.accent = { 0.15, 0.68, 0.85, 1.0 }        -- Stylized Cyan / Teal Accent
theme.accent_dim = { 0.10, 0.45, 0.60, 1.0 }
theme.bg = { 0.09, 0.09, 0.11, 1.0 }
theme.bg_panel = { 0.11, 0.11, 0.14, 1.0 }
theme.bg_child = { 0.12, 0.13, 0.16, 1.0 }
theme.fg = { 0.90, 0.90, 0.93, 1.0 }
theme.fg_dim = { 0.50, 0.52, 0.58, 1.0 }
theme.selection = { 0.20, 0.45, 0.55, 1.0 }
...
function theme.apply()
  ...
  ig.push_style_color(c.SliderGrabActive, 0.35, 0.85, 1.0, 1)
