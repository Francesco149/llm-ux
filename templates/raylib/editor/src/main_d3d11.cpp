...
void lua_init(const char* root_dir) {
    ...
    DWORD attr = GetFileAttributesA(dev_dir);
...
static void setup_imgui_fonts_and_theme() {
    ...
    static const ImWchar latin_cyr[] = {
        ...
        0x1E00, 0x1EFF, 0x0400, 0x052F, 0x0370, 0x03FF,
        0x2000, 0x206F, 0x20AC, 0x20AC, 0x2190, 0x21FF,
        0x2500, 0x25FF, 0,
    };

    char latin_path[1024] = "assets/fonts/InterVariable.ttf";
    char cjk_path[1024]   = "assets/fonts/ipag.ttf";
    ...
    static const ImWchar cjk_ranges[] = {
        0x3000, 0x30FF, 0x31F0, 0x31FF, 0x3400, 0x4DBF,
        0x4E00, 0x9FFF, 0xF900, 0xFAFF, 0xFF00, 0xFFEF, 0,
    };
    ImFontConfig mcfg;
    mcfg.MergeMode = true;
