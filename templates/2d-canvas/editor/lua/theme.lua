...
theme.accent = { 0.96, 0.62, 0.04, 1 }    -- vibrant amber
theme.accent_dim = { 0.60, 0.40, 0.15, 1 }
theme.bg = { 0.09, 0.09, 0.11, 1 }
theme.bg_panel = { 0.11, 0.11, 0.14, 1 }
theme.bg_child = { 0.12, 0.13, 0.16, 1 }
theme.fg = { 0.90, 0.90, 0.93, 1 }
theme.fg_dim = { 0.50, 0.52, 0.58, 1 }
theme.selection = { 0.28, 0.32, 0.40, 1 }
